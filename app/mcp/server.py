...
mcp = FastMCP(
    ...
    instructions=(
        ...
        'Единственное исключение — DCFR и COMP: они не привязаны к национальной юрисдикции и привлекаются для любой.\n'
        'Более того, это не право, а ОБЯЗАННОСТЬ. По любому вопросу о конкретной юрисдикции DCFR и COMP просматриваются ВСЕГДА, наравне с источниками самой юрисдикции: они показывают, стоит ли за национальным решением общеевропейская модель или, наоборот, национальная особенность. Ответ, где национальные источники есть, а DCFR и COMP не искали, считается неполным.\n'
        'В ответе слой DCFR/COMP держится ОТДЕЛЬНО от национального и никогда его не подменяет: сначала — как вопрос решён в самой юрисдикции (со сноской на её источник), затем — что об этом говорит наднациональный слой (со своей сноской). Если по нему ничего не нашлось, это помечается, а не опускается молча.\n'
        '\n'
