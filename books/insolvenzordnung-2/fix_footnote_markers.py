...
одним блоком без номера — таких блоков в томе 3175, то есть структура сносок
теряется целиком, а при загрузке они отсеиваются (в схеме приёмника номер
сноски обязателен и целочисленный).
