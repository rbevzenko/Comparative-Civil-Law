...
- Rdn., раздел 1: 7 → 12 (нет 4)
- Rdn., раздел 1: 13 → 17 (нет 3)
- Rdn., раздел 1: 23 → 26 (нет 2)
- Rdn., раздел 1: 26 → 31 (нет 4)
- Rdn., раздел 1: 32 → 35 (нет 2)
- Rdn., раздел 1: 40 → 45 (нет 4)
- Rdn., раздел 1: 45 → 48 (нет 2)
- Rdn., раздел 1: 48 → 53 (нет 4)
- Rdn., раздел 1: 61 → 64 (нет 2)
- Rdn., раздел 2: 4 → 6 (нет 1)
- Rdn., раздел 2: 7 → 10 (нет 2)
- Rdn., раздел 2: 10 → 12 (нет 1)
- Rdn., раздел 2: 12 → 18 (нет 5)
- Rdn., раздел 2: 18 → 24 (нет 5)
- Rdn., раздел 2: 24 → 27 (нет 2)
- Rdn., раздел 2: 27 → 38 (нет 10)
- Rdn., раздел 2: 38 → 43 (нет 4)
- Rdn., раздел 2: 44 → 48 (нет 3)
- Rdn., раздел 2: 48 → 50 (нет 1)
- Rdn., раздел 2: 51 → 54 (нет 2)
...
- 6602 символов, офсеты 290281–296883 в book.txt
...
de-inso-jaeger-1:rdn:33, de-inso-jaeger-1:rdn:2/21
...
Zulässigkeit des Insolvenzverfahrens § 11
keine handelsrechtliche Zweckrichtung und Geschäftsaufnahme, so liegt vor der Eintragung eine Gesellschaft bürgerlichen Rechts (GbR) vor. Der Übergang und die Unterscheidung von OHG und GbR sind fließend.203 Wurde bislang kein Geschäftsbetrieb aufgenommen und ist die Gesellschaft nicht am Markt aufgetreten, so liegt eine GbR als reine
Innengesellschaft vor.204 Die Insolvenzfähigkeit des Verbandes besteht dabei in seiner
jeweiligen Form und erstreckt sich auf das betroffene Sondervermögen der Gesellschaft.
Ist der Gesellschaftsvertrag unwirksam, so stellt dies kein Hindernis für die Durchführung eines Insolvenzverfahrens dar, solange die Gesellschaft Trägerin eines Sondervermögens ist.205 Eine Gesellschaft, welche auf einer fehlerhaften oder unwirksamen Vertragsgrund…

> [203] S nur MünchHdbGesR II/Happ, § 2 Weber KO, §§ 209, 210 Rn 3; MünchHdb- Rn 18 ff und Κ Schmidt, Gesellschaftsrecht GesR I/Happ/Brunkhorst, § 5 Rn 6; Münch- (2002) 46 III. Komm InsO/O«, § 11 Rn 47; ähnli
...
das Verfahren betreffendes Verhältnis aufzuklären und ein Antrag nicht eigens gefordert
ist, dem Grundsatz der Amtsermittlung (Untersuchungsgrundsatz), s hierzu bereits § 4
Rn 55. Damit strebt das Gesetz eine glatte und beschleunigte Abwicklung des Verfahrens
an. Die Abweichung gegenüber dem ordentlichen Zivilprozess rechtfertigt sich durch
den besonderen Zweck des Insolvenzverfahrens, das den Belangen einer Vielheit konkurrierender Gläubiger dient. Im Gegensatz zu § 75 KO formuliert § 5 nicht mehr, dass das
Gericht die erforderlichen Ermittlungen vornehmen „kann", sondern dass es alle
Umstände zu ermitteln „hat", die für das Verfahren von Bedeutung sind. Diese Formulierung schließt lediglich klarstellend ein Ermessen des Gerichts in der Frage aus, ob es
bedeutsame Umstände tatsächlich ermitteln soll…

> [226] Stand: 31. 10. 2 0 03
